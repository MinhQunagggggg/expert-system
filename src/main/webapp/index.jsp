...
<html class="no-js" lang="vi">
    ...
    <body>
        ...
        <div class="slider_area slider_style home_three_slider owl-carousel">
            <div class="single_slider" data-bgimg="assets/img/slider/slider4.png">
                <div class="container">
            ...
            <div class="single_slider" data-bgimg="assets/img/slider/slider5.png">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-12">
            ...
            <div class="container-fluid">
                <div class="row ">
                    <div class="col-lg-6 col-md-6">
                        <div class="banner_area">
                            <div class="banner_thumb">
                                <a href="product"><img src="assets/img/bg/banner11.png" alt="#"></a>
                                <div class="banner_content">
                                    <h1>Handbag <br>Collection</h1>
                                    <a href="product">Discover Now</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="banner_area">
                            <div class="banner_thumb">
                                <a href="product"><img src="assets/img/bg/banner12.png" alt="#"></a>
                                <div class="banner_content">
                                    <h1>Sneaker <br>Collection</h1>
                                    <a href="product">Discover Now</a>
                                </div>
                            </div>
                        </div>
